...
@section('title', 'Tambah Lokasi KKN - Admin')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Lokasi KKN Baru</h1>
            ...
            <form action="{{ route('admin.locations.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('total_quota') is-invalid @enderror"
                           id="total_quota" name="total_quota" value="{{ old('total_quota') }}" min="1" required>
                    @error('total_quota')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control faculty-quota"
                                                   ...
                                                   value="{{ old('faculty_quotas.'.$faculty->id, 0) }}"
                                                   min="0">
                                        </td>
                                    </tr>
                                    @endforeach
